...
<hr>
			...
			<form method="post" action="/admin/users/create" class="form-horizontal" autocomplete="off">
				...
				<div class="row">
					...
					<div class="col-xs-3">
						...
						<!-- QR-Key -->
						<div class="control-group {{ $errors->has('QRkey') ? 'error' : '' }}">
						<label class="control-label" for="city">QR-Key*</label>
							<div class="controls">
								<input type="text" name="QRkey" id="QRkey" value="{{ Input::old('QRkey') }}" />
								{{ $errors->first('QRkey', '<span class="help-inline">:message</span>') }}
							</div>
						</div>
