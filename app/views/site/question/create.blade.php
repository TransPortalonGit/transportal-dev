...
<div style="width: 700px; margin-bottom: 30px">
    <h4 style="float: left;">Create a new Question</h4>
    <div style="float:right; margin-top: 20px; margin-right: 70px;"><span style="color:#d9534f; font-size: 16px">* </span><span style="font-size: 12px"">required field</span></div>
    <div style="clear:both;"></div>
    <hr>
</div>

{{ Form::open(['class'=>'form-horizontal', 'role'=>'form', 'route' => 'question.store', 'method' => 'post']) }}
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-7" style="">
