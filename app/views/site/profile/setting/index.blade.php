...
function storeIncognito() {

  if (document.getElementById('incognito').checked) 
  {
    document.getElementById("stored_incognito").value = 1;
  } 
  else 
  {
    document.getElementById("stored_incognito").value = 0;     
  }  
}
...
@section('content')
            ...
            <div class="modal fade bs-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <hr>                 
                   <form method="post" action="/profile/setting/updatepic" role="form" enctype="multipart/form-data">
        ...
        <div style="background-color: #FDB363; width: 170px; color: #ffffff; padding-left: 5px;">
          <div class="checkbox" title="People won't see that you are in lab" >
            <label>
              ...
              <input {{($user->incognito == 1)? 'checked': ''}} type="checkbox" name="incognito" id="incognito" value="1" onclick="storeIncognito()">
              Hide lab status
            </label>
          </div>
        </div>
    ...
    <h4><i class="fa fa-wrench"></i> General Settings</h4>
    <hr>
    <ul style="list-style: none; margin:0; padding:0; display: inline-block; width: 100%;">
      ...
      <form id="setting-facebook"role="form">
        ...
        <div class="form-group">
          ...
          <input placeholder="{{$user->facebook}}" type="text" name="facebook" id="facebook" class="form-control" >
        </div>     
      ...
      <li id="item-googleplus">     
        <div id="item-label"><strong class="col-sm-2">Google+:</strong></div>
  ...
  <form method="post" action="setting/update" autocomplete="off">
    <!-- CSRF Token -->
    <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}" />
    <input type="hidden" name="_id" value="{{ $user->id }}" />

  <div class="user-description">
    <h4><i class="fa fa-quote-left"></i> Your Description</h4>
    <hr>  
  ...
  <div class="password"> 
    <h4><i class="fa fa-key"></i> Your Password</h4>
    <hr>
  ...
  <input type="hidden" name="stored_incognito" id="stored_incognito" value="{{$user->incognito}}" placeholder="{{$user->incognito}}" class="form-control" >

  <div style="margin-top: 20px; display: inline; float: right;">
    <a href="/profile/show/{{Sentry::getUser()->username}}"><button style="width:80px; border-radius: 0;" type="button" class="btn btn-warning">Cancel</button></a>
